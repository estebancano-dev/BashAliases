...
subdomains(){
	...
	amass enum -active -brute -min-for-recursive 4 -d $1 -o ~/tools/recon/$1/1scrap$1.txt > /dev/null 2>&1 | cat ~/tools/recon/$1/1scrap1$1.txt >> ~/tools/recon/$1/1scrap$1.txt
	rm ~/tools/recon/$1/1scrap1$1.txt
