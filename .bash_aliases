...
subdomains(){
	...
	touch 1scrap1$1.txt 1scrap2$1.txt 1scrap3$1.txt
	...
	subfinder -t 100 -d $1 -silent -o 1scrap1$1.txt > /dev/null 2>&1
	
	echo -e "\e[32mDoing Sublist3r...\033[0m"
	python ~/tools/Sublist3r/sublist3r.py -d $1 -o 1scrap2$1.txt > /dev/null 2>&1
	
	echo -e "\e[32mDoing Amass...\033[0m"
	amass enum -d $1 -o 1scrap3$1.txt > /dev/null 2>&1
	...
	rm -f 1scrap1$1.txt 1scrap2$1.txt 1scrap3$1.txt
